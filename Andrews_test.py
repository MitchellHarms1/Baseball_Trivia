...
pygame.init()
# 21st century
blue = [q1,q2,q3,q4,q5,q6,q7,q8,q9,q10]
green = [q11,q12,q13,q14,q15,q16,q17,q18,q19,q20]
...
#Game loop
while running:
    btn_blue.when_pressed = lambda: get_question("blue")
    btn_red.when_pressed = lambda: get_question("red")
    btn_green.when_pressed = lambda: get_question("green")
    btn_yellow.when_pressed = lambda: get_question("yellow")
